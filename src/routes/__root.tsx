...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OLMED Łęczna — Serwis, części i OSKP · Piotr i Radosław Medyńscy" },
      ...
      { property: "og:title", content: "OLMED Łęczna — Serwis, części i OSKP" },
      { property: "og:description", content: "Rodzinny serwis samochodowy, części, klimatyzacja, opony i OSKP w Łęcznej. 25 lat doświadczenia." },
